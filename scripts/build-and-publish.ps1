...
$InitFile = Join-Path $PSScriptRoot "..\src\causaliq_analysis\__init__.py"
...
Write-Host "Building causaliq-analysis version $Version..." -ForegroundColor Blue

# Clean previous builds
Write-Host "Cleaning previous builds..." -ForegroundColor Yellow
if (Test-Path "dist") { Remove-Item -Recurse -Force "dist" }
if (Test-Path "build") { Remove-Item -Recurse -Force "build" }
if (Test-Path "src\causaliq-analysis.egg-info") { Remove-Item -Recurse -Force "src\causaliq-analysis.egg-info" }
