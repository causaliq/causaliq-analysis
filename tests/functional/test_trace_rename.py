...
def test_trace_rename_type_error_1():  # bad argument types
    trace = Trace.read("TABU/STD/asia", TESTDATA_DIR + "trace")["N1000"]
...
# valid tabu trace, rename 1 node
...
# valid tabu trace, rename all nodes
...
# tabu with knowledge, replace all
def test_trace_rename_asia_3_ok():  # tabu with knowledge, replace all
    trace = Trace.read("TABU/EQV/L012/asia", TESTDATA_DIR + "trace")["N1000_0"]
    orig_trace = deepcopy(trace)
    ...
    assert trace.trace["knowledge"] == [
        None,
        ("equiv_add", True, "swap_best", ("x7dys", "x4bro")),
        ("equiv_add", True, "no_op", ("x5lun", "x0eit")),
        None,
        None,
        ("equiv_add", True, "no_op", ("x1smo", "x4bro")),
        ("equiv_add", True, "swap_best", ("x5lun", "x1smo")),
        None,
        ("act_cache", True, "stop_rev", ("x1smo", "x5lun")),
        ("equiv_add", None, "no_op", ("x6tub", "x1smo")),
        None,
        None,
        ("act_cache", True, "stop_rev", ("x1smo", "x5lun")),
        ("act_cache", True, "stop_rev", ("x1smo", "x5lun")),
